...
int main()
{
    ...
    for (int c=0; c<5; c++)
    {
        ...
        list<studentas>:: iterator iteratorius = sarasas.begin();
        while(iteratorius != sarasas.end())
        {
            if(iteratorius->Galutinis < 5)
            {
                nenaudeliai.push_back(*iteratorius);
                iteratorius = sarasas.erase(iteratorius);
            }
            else iteratorius++;
        }
        ...
        for (auto iteratorius: sarasas)
        {
            out_kiet << iteratorius.Vardas << setw(20) << iteratorius.Pavarde << setw(18) << iteratorius.Galutinis << endl;
        }
        out_kiet.close();
        ...
        for (auto iteratorius: nenaudeliai)
        {
            out_nen << iteratorius.Vardas << setw(20) << iteratorius.Pavarde << setw(18) << iteratorius.Galutinis << endl;
        }
        out_nen.close();
